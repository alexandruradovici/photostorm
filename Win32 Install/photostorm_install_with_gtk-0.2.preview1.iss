;PhotoStorm Desktop Win32-0.2.preview1 and GTK 2.4.3-rev-a Install Script

[Setup]
AppName=PhotoStorm Desktop
AppVerName=PhotoStorm Desktop Win32-0.2.preview1
AppVersion=0.2.preview1
...
SourceDir=.
OutputDir=.\Kit
OutputBaseFilename=PhotoStorm_with_Gtk_Win32-0.2.preview1
...
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\photostorm.exe"; ValueType: string; ValueData: "{app}\photostorm"; Flags: uninsdeletevalue
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\photostorm.exe"; ValueType: string; ValueData: "{app}\photostorm"; Flags: uninsdeletevalue
...
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\ps_trayicon.exe"; ValueType: string; ValueData: "{app}\ps_trayicon"; Flags: uninsdeletevalue
Root: HKLM; Subkey: "Software\Microsoft\Windows\CurrentVersion\App Paths\ps_trayicon.exe"; ValueType: string; ValueData: "{app}\ps_trayicon"; Flags: uninsdeletevalue
...
Source: "pics\logos\wizard_1.jpg"; DestDir: "{app}\pics\logos"; DestName: "wizard_1.jpg"; CopyMode: normal
Source: "pics\logos\wizard_2.jpg"; DestDir: "{app}\pics\logos"; DestName: "wizard_2.jpg"; CopyMode: normal
Source: "pics\logos\add_one_photo.png"; DestDir: "{app}\pics\logos"; DestName: "add_one_photo.png"; CopyMode: normal
Source: "pics\logos\add_more_photos.png"; DestDir: "{app}\pics\logos"; DestName: "add_more_photos.png"; CopyMode: normal
Source: "pics\logos\add_photo_finished.jpg"; DestDir: "{app}\pics\logos"; DestName: "add_photo_finished.jpg"; CopyMode: normal
Source: "pics\logos\add_photo_info.jpg"; DestDir: "{app}\pics\logos"; DestName: "add_photo_info.jpg"; CopyMode: normal
Source: "pics\logos\add_photos.png"; DestDir: "{app}\pics\logos"; DestName: "add_photos.png"; CopyMode: normal
Source: "pics\logos\add_photos_folder.jpg"; DestDir: "{app}\pics\logos"; DestName: "add_photos_folder.jpg"; CopyMode: normal
Source: "pics\logos\album_properties.jpg"; DestDir: "{app}\pics\logos"; DestName: "album_properties.jpg"; CopyMode: normal
Source: "pics\logos\config.jpg"; DestDir: "{app}\pics\logos"; DestName: "config.jpg"; CopyMode: normal
Source: "pics\logos\create_album.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album.jpg"; CopyMode: normal
Source: "pics\logos\create_album_author_name.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album_author_name.jpg"; CopyMode: normal
Source: "pics\logos\create_album_category.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album_category.jpg"; CopyMode: normal
Source: "pics\logos\create_album_description.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album_description.jpg"; CopyMode: normal
Source: "pics\logos\create_album_finished.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album_finished.jpg"; CopyMode: normal
Source: "pics\logos\create_album_name.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album_name.jpg"; CopyMode: normal
Source: "pics\logos\create_album_password.jpg"; DestDir: "{app}\pics\logos"; DestName: "create_album_password.jpg"; CopyMode: normal
Source: "pics\logos\messages.jpg"; DestDir: "{app}\pics\logos"; DestName: "messages.jpg"; CopyMode: normal
Source: "pics\logos\nr_of_photos.png"; DestDir: "{app}\pics\logos"; DestName: "nr_of_photos.png"; CopyMode: normal
Source: "pics\logos\photo_filename.png"; DestDir: "{app}\pics\logos"; DestName: "photo_filename.png"; CopyMode: normal
Source: "pics\logos\photostorm2.png"; DestDir: "{app}\pics\logos"; DestName: "photostorm2.png"; CopyMode: normal
...
Source: "Gtk\gtk-runtime-2.4.3-rev-a.exe"; DestDir: "{tmp}"; DestName: "gtk-runtime-2.4.3-rev-a.exe"; CopyMode: dontcopy
...
begin
  ...
  Result := GetGtkInstalled ();
    ...
    instGtk := MsgBox ('The GTK 2.4.3 Libraries are not installed. Would you like to install them now?', mbConfirmation, MB_YESNO) = idYes;
    if (instGtk) then
      if (ExtractTemporaryFile ('gtk-runtime-2.4.3-rev-a.exe')) then
      begin
        InstExec (ExpandConstant('{tmp}')+'\gtk-runtime-2.4.3-rev-a.exe', ExpandConstant('{tmp}'), '', true, false, 0, r);
        GetGtkInstalled ();
        if (r <> 0) then MsgBox ('The GTK 2.4.3 Libraries could not be installed. Please sent an email to alex@photostorm.net for help. PhotoStorm might not start.', mbError, MB_OK);
      end;
    end;
  Result := true;
end;
