#!/bin/sh
echo "Welcome to PhotoStorm v0.1.1"
echo  ""
echo "PhotoStorm will be installed in /usr/local"
echo "Installing binaries"
tar xvfz photostorm-bin-0.1.1.tgz -C /usr/local/bin > /dev/null
echo "Installing data"
tar xvfz photostorm-data-0.1.1.tgz -C /usr/local/lib > /dev/null
echo "Configuring"
